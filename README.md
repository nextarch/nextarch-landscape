[![Dependency Status](https://img.shields.io/david/nextarch/nextarch-landscape.svg?style=flat-square)](https://david-dm.io/nextarch/nextarch-landscape) [![Netlify Status](https://api.netlify.com/api/v1/badges/f10af739-2511-4295-9a8c-ed65416144ea/deploy-status)](https://app.netlify.com/sites/nextarch-landscape/deploys)

# NextArch Landscape

![NextArch Landscape Logo](./images/left-logo.svg)

- [NextArch Landscape](#nextarch-landscape)
